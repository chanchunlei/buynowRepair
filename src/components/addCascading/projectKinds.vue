<template>
  <div v-loading="this.$store.state.loading">
    ...
    <div class="inpBox">
      <div class="inpItem" v-for="item in projectData" :key="item.rtid">
        <el-input class="inp" disabled v-model="item.repairTypeName" placeholder="请输入内容"></el-input>
    ...
    <el-dialog title="编辑：" :visible.sync="dialogFormVisible">
      <el-input class="inp" v-model="input.repairTypeName" placeholder="请输入内容"></el-input>
        ...
        deleteItem(item) {  //点击删除
          ...
          api.projectAlter({
            query: {
              id: this.input.rtid,
              type: 'rt',
              name: this.input.repairTypeName
            },
            success: res => {
