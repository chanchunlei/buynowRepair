<template>
  <div v-loading="this.$store.state.loading">
    ...
    <h2 class="title">维修名称：</h2>
    <div class="inpBox">
      <div class="inpItem" v-for="item in projectChilerenData" :key="item.rid">
        <el-input class="inp" disabled v-model="item.repairName" placeholder="请输入内容"></el-input>
    ...
    <el-dialog title="编辑：" :visible.sync="dialogFormVisible">
      <el-input class="inp" v-model="input.repairName" placeholder="请输入内容"></el-input>
